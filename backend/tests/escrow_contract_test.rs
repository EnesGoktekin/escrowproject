    ...
    setup.blockchain_wrapper
        .execute_tx(
            ...
            |sc| {
                ...
                sc.create_offer(managed_address!(&setup.second_user_address.to_address()));
            },
        )
        .assert_ok();
...
fn test_create_self_offer(){
    ...
    setup.blockchain_wrapper
        .execute_tx(
            ...
            &rust_biguint!(OFFER_AMOUNT),
            |sc| {
                sc.create_offer(managed_address!(&setup.first_user_address.to_address()));
            },
        )
        .assert_error(4,"Cannot create offer for yourself.")
